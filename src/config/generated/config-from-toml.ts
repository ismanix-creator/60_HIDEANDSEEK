 ...
 * @updated     2026-01-16 19:23:21 CET
 * @author      Akki Scholze
 */
...
export const configFromToml = {
  app: {
    meta: {
      ...
      version: '0.2.3',
      lastUpdated: '2026-01-16T02:18:45+01:00'
    },
    locale: {
      language: 'de-DE',
      currency: 'EUR',
  ...
  navigation: {
    items: ['dashboard', 'material', 'kunden', 'schuldner', 'glaeubiger', 'settings'],
    item: [
      {
        key: 'dashboard',
        label: 'Dashboard',
  ...
  components: {
    ...
    table: {
      ...
      columns: {
        ...
        kundenViewPostenNoMat: {
          order: ['datum', 'notiz', 'gesamt', 'bezahlt', 'offen', 'status', 'fortschritt', 'aktionen'],
          labels: {
            datum: 'Datum',
            notiz: 'Notiz',
            gesamt: 'Gesamt',
        ...
        schuldner: {
          order: ['datum', 'name', 'notiz', 'betrag', 'bezahlt', 'offen', 'status', 'fortschritt', 'aktionen'],
          labels: {
            datum: 'Datum',
            name: 'Name',
            notiz: 'Notiz',
    ...
    status: {
      common: {
        order: ['wartend', 'in_bearbeitung', 'erledigt'],
        rule: {
          wartend: {
            when: {
              started: false
      ...
      material: {
        order: ['wartend', 'in_bearbeitung', 'bestand_0_aber_aussenstaende', 'erledigt'],
        rule: {
          wartend: {
            when: {
              started: false
    ...
    dialog: {
      ...
      form: {
        material: {
          ...
          order: ['datum', 'bezeichnung', 'notiz', 'ek_stck', 'ek_gesamt', 'vk_stck', 'menge'],
          field: {
            datum: {
              entryType: 'date',
              label: 'Datum',
        ...
        kundenviewPostenMat: {
          gridPc: 'twoColumn',
          gridSmartphone: 'oneColumn',
          order: ['datum', 'vk_stck', 'gesamt', 'menge'],
          field: {
            datum: {
              entryType: 'date',
              label: 'Datum',
        ...
        materialBar: {
          gridPc: 'oneColumn',
          gridSmartphone: 'oneColumn',
          order: ['material', 'datum', 'bar', 'notiz'],
          field: {
            material: {
        ...
        materialRechnung: {
          gridPc: 'twoColumn',
          gridSmartphone: 'oneColumn',
          order: ['kunde', 'datum', 'material', 'menge', 'vk_stck', 'notiz'],
          field: {
            kunde: {
