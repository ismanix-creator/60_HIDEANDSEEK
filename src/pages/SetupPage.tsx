...
export function SetupPage() {
  ...
  return (
    <div
      style={{
        padding: appConfig.theme.spacing.layout.pagePadding,
        maxWidth: '600px',
        margin: '0 auto'
      }}
    >
      ...
      <div
        style={{
          marginBottom: appConfig.theme.spacing.layout.pagePadding,
          display: 'flex',
          gap: appConfig.theme.spacing.dialog.contentGap
        }}
      >
      ...
      {status && (
        <div style={{ marginTop: appConfig.theme.spacing.layout.pagePadding }}>
